...
<!-- BEGIN SCRIPTS + CSS -->
	...
	<!-- BEGIN CALL JS -->
	<script src="/static/js/pageloader.js" type="text/javascript"></script>
	<!-- END CALL JS -->

	<!-- BEGIN CALL CSS -->
	<link rel="stylesheet" id="pageloader-css"  href="/static/css/pageloader.css" type="text/css" media="all" />
	<!-- END CALL CSS -->
